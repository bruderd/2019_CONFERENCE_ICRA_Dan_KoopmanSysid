...
With the approximation of the Koopman operator $\bar{U}^{T_s}$ found in Section \ref{sec:step2}, we can solve for the infinitesimal generator of the Koopman semigroup \Ram{complain.} $\bar{A}$ by inverting \eqref{eq:U2L}
\begin{align}
